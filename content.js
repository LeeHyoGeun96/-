...
var paper = function (self, undefined) {
      ...
      statics: {
        ...
        getSource: function (list) {
          ...
          if (source === undefined) {
            ...
            source = list.__source =
              arg && Base.isPlainObject(arg) ? arg : null;
          }
          return source;
        },
    ...
    function getDiscriminant(a, b, c) {
      ...
      if (abs(D) * 3 < E) {
        var ad = split(a),
          ...
          q = a * c,
          dq =
            ad[0] * cd[0] - q + ad[0] * cd[1] + ad[1] * cd[0] + ad[1] * cd[1];
        D = p - q + (dp - dq);
      }
      return D;
    }
  ...
  var Item = Base.extend(
        ...
        function serialize(fields) {
          for (var key in fields) {
            ...
            if (
              !Base.equals(
                value,
                key === "leading" ? fields.fontSize * 1.2 : fields[key]
              )
            ) {
    ...
    },
    {
      ...
      getLastChild: function () {
        return (
          (this._children && this._children[this._children.length - 1]) || null
        );
      },
      ...
      function hitTestChildren(point, options, viewMatrix, _exclude) {
        ...
        if (children) {
          for (var i = children.length - 1; i >= 0; i--) {
            ...
            var res =
              child !== _exclude && child._hitTest(point, options, viewMatrix);
    ...
    ),
    {
      ...
      _drawSelection: function (
        ...
        var selection = this._selection,
          ...
          boundsSelected =
            selection & 2 || (itemSelected && this._selectBounds),
  ...
  var Group = Item.extend({
    ...
    _hitTestChildren: function _hitTestChildren(point, options, viewMatrix) {
      ...
      return (
        ...
        _hitTestChildren.base.call(this, point, options, viewMatrix, clipItem)
      );
    },
      ...
      return {
        _contains: function _contains(point) {
          if (this._type === "rectangle") {
            ...
            return center
              ? point.subtract(center.point).divide(this._radius).getLength() <=
                  1
          ...
          if (hitStroke || hitFill) {
            ...
            if (type === "rectangle") {
              ...
              if (center) {
                ...
                hit =
                  outer._containsPoint(point) && !inner._containsPoint(point);
              }
            } else {
  ...
  var PathItem = Item.extend({
    ...
    setPathData: function (data) {
      var parts = data && data.match(/[mlhvcsqtaz][^mlhvcsqtaz]*/gi),
        coords,
        relative = false,
        previous,
        control,
    ...
    getIntersections: function (path, include, _matrix, _returnFirst) {
      ...
      return self ||
        this.getBounds(matrix1).intersects(path.getBounds(matrix2), 1e-12)
    ...
    },
    {
      ...
      isFullySelected: function () {
        ...
        return (
          this.isSelected() &&
          length > 0 &&
          this._segmentSelection === length * 7
        );
      },
        ...
        if (strokeRadius !== null) {
          ...
          if (!loc && join === "miter" && numSegments > 1) {
            for (var i = 0; i < numSegments; i++) {
              ...
              if (
                point.getDistance(segment._point) <=
      ...
      return Base.each(
        ...
        },
        {
          ...
          setAlpha: function (alpha) {
            this._alpha =
              alpha == null ? null : Math.min(Math.max(alpha, 0), 1);
            this._changed();
          },
  ...
  var View = Base.extend(
    ...
    new (function () {
      ...
      function getView(event) {
        ...
        return (
          target.getAttribute && View._viewsById[target.getAttribute("id")]
        );
      }
      ...
      function emitMouseEvents(view, hitItem, type, event, point, prevPoint) {
        ...
        return (
          (dragItem &&
            emitMouseEvent(dragItem, null, type, event, point, prevPoint)) ||
          (hitItem &&
            hitItem !== dragItem &&
      ...
      return {
        ...
        _handleMouseEvent: function (type, event, point) {
          ...
          if (handle && tool) {
            called =
              tool._handleMouseEvent(type, event, point, mouse) || called;
          }
          ...
          function emit(obj) {
            if (obj.responds(type)) {
              ...
              obj.emit(
                type,
                (keyEvent =
                  keyEvent || new KeyEvent(type, event, key, character))
              );
            }
          }
  ...
  var BlendMode = new (function () {
    ...
    var modes = {
      ...
      "color-dodge": function () {
        dr =
          br === 0 ? 0 : sr === 255 ? 255 : min(255, (255 * br) / (255 - sr));
        dg =
          bg === 0 ? 0 : sg === 255 ? 255 : min(255, (255 * bg) / (255 - sg));
        db =
          bb === 0 ? 0 : sb === 255 ? 255 : min(255, (255 * bb) / (255 - sb));
      },
      ...
      "color-burn": function () {
        dr =
          br === 255
            ...
            : sr === 0
            ? 0
            : max(0, 255 - ((255 - br) * 255) / sr);
        dg =
          bg === 255
            ? 255
            : sg === 0
            ? 0
            : max(0, 255 - ((255 - bg) * 255) / sg);
        db =
          bb === 255
            ? 255
            : sb === 0
            ? 0
            : max(0, 255 - ((255 - bb) * 255) / sb);
      },
  ...
  new (function () {
    ...
    function getDefinition(item, type) {
      ...
      return (
        item &&
        definitions.svgs[
          type + "-" + (item._id || item.__id || (item.__id = UID.get("svg")))
        ]
      );
    }
      ...
      exportSVG: function (options) {
        ...
        if (matrix && !matrix.isIdentity()) {
          parent = node.appendChild(
            SvgElement.create("g", getTransform(matrix), formatter)
          );
        }
        for (var i = 0, l = children.length; i < l; i++) {
  ...
  new (function () {
    ...
    function importGradient(node, type) {
      ...
      var origin,
        ...
        highlight,
        scaleToBounds =
          getValue(node, "gradientUnits", true) !== "userSpaceOnUse";
      if (radial) {
    ...
    var importers = {
      ...
      rect: function (node) {
        return new Shape.Rectangle(
          new Rectangle(getPoint(node), getSize(node)),
          getSize(node, "rx", "ry")
        );
      },
      ...
      text: function (node) {
        var text = new PointText(
          getPoint(node).add(getPoint(node, "dx", "dy"))
        );
    ...
    function applyAttributes(item, node, isRoot) {
      ...
      Base.each(attributes, function (apply, name) {
        ...
        item =
          (value !== undefined && apply(item, value, name, node, styles)) ||
          item;
      });
      return item;
    }
    ...
    if (!acorn) {
      ...
      (function (root, mod) {
        ...
        function parseFunction(node, isStatement) {
          ...
          if (
            strict ||
            (node.body.body.length && isUseStrict(node.body.body[0]))
          ) {
          ...
          if (tokType === _name) {
            if (
              ...
              ((options.forbidReserved &&
                (options.ecmaVersion === 3 ? isReservedWord3 : isReservedWord5)(
                  tokVal
                )) ||
...
function getHexColor(raster, i, j) {
  console.log(`i, j : ${i}, ${j}`);
  let hex = null;
  let color = raster.getAverageColor(
...
function makeCanvas(img, canvasArr, index, ctxArr) {
  ...
  canvasArr[index].style.position = "absolute";
  canvasArr[index].style.top = imgBound.top + 100 + "px";
  canvasArr[index].style.left = imgBound.left + 100 + "px";
